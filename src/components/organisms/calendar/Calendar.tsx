   ...
   return (
      <div className="w-full h-full flex flex-col pt-8 pb-8 pl-10 pr-10">
         ...
         <div className="w-full flex flex-col md:flex-row justify-between">
            <div className="md:w-[65%] w-[95%] h-[60%]  overflow-auto">
            ...
            <div className="md:w-[30%] w-[90%] h-full mt-8 md:mt-0">
               <Calendar value={date} onChange={handleDateChange} />
            </div>
         </div>
         <div className="w-full flex flex-col md:flex-row justify-between items-center mt-3 ">
            <div className="w-[60%] h-[4rem] flex justify-evenly mt-2 gap-2 md:gap-0">
