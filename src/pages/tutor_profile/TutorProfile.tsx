// THE TUTOR VIEW OF HIS OWN PROFILE
   ...
   return (
      <div className="">
         ...
         <div className="bg-[#3787FD29] px-14">
            <div className="flex justify-between flex-wrap gap-4 items-center bg-white px-4 py-6 shadow-md translate-y-20 max-w-4xl mx-auto">
               ...
               <Link
                  to={'/edit-profile'}
                  className="py-2 px-4 bg-[#2B7CF8] text-white font-bold"
               >
                  Edit profile{' '}
               </Link>
            </div>
         ...
         <div className="mt-20 max-w-7xl mx-auto py-12 px-6 flex gap-10 sm:gap-4 flex-wrap-reverse">
            ...
            <div className="p-4 sm:sticky sm:top-5 self-end  bg-[#ECEDEE] flex flex-col gap-4 border-2 border-[#2B7CF8] rounded-lg">
               ...
               <button className="bg-[#2B7CF8] text-white rounded-lg py-3 flex justify-center items-center gap-2">
                  <BsPencilFill />
